    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 200; i++) {
            ...
            for (MemoryPoolMXBean memoryPoolMXBean : ManagementFactory.getMemoryPoolMXBeans()) {
                System.err.println(memoryPoolMXBean.getName() + "  总量:" + memoryPoolMXBean.getUsage().getCommitted() / M + "   使用的内存:" + memoryPoolMXBean.getUsage().getUsed() / M);
            }
        }
    }
